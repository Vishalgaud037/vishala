...
public class Demo5 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		boolean select1 = select.isMultiple();
		System.out.println(select1);//false single select listbox we cant use deselect
		
		WebElement listBox1=driver.findElement(By.id("A2"));
	Select select2=new Select(listBox1);
	boolean multiple2 = select2.isMultiple();
	System.out.println(multiple2);//true multi select listbox we can use deselect
	}
}
